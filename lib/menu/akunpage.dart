        ...
        children: [
          Stack(
            ...
            children: [
              ...
              const Positioned(
                top:
                    50, // Sesuaikan nilai ini untuk mengatur posisi vertikal foto profil
                child: CircleAvatar(
                  radius: 50,
          ...
          const SizedBox(
              height:
                  60), // Sesuaikan untuk memberikan ruang di bawah foto profil
          const Text(
            'Mas Ilham',
            style: TextStyle(
          ...
          buildListTile(context, Icons.person_outline, 'Profil Akun',
              const ProfilAkunPage()),
          buildListTile(context, Icons.info_outline, 'Ubah Password',
              const UbahPasswordPage()),
          buildListTile(context, Icons.add_circle_outline, 'Tambah GH',
              const TambahGHPage()),
          buildListTile(context, Icons.home_work_outlined, 'Profil GH',
              const ProfilGHPage()),
          buildListTile(context, Icons.info_outline, 'Tentang Aplikasi',
